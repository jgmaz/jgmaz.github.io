...
<!-- specificity has a strict meaning in statistics that not every reader knows. Are we controlling for specificity? Then, explain what "evaluation-suppression" is operationalized as here. If more specific then not loose the reader. -->
<!-- Very nice control experiment using informal / formal language -> elaborate briefly why this is a good control -->
...
<!-- Great! Motivate why different positions were used. in previous section, I see now! -->
<!-- The word trial is introduced for the first time - what is it? And timepoint, use token positions? -->
...
<!-- I don't understand the cue / steering axis vectors -->
...
<!-- I am not a fan of correlation plots - very difficult for the reader to quickly understand what you are trying to say. Consider removing them or have at most 3x3 -->
...
<!-- I think this experiment does something more intersting than what you are suggesting. There is a semantic similarity between formal/informal and eval/deployment which sounds more like what you are controlling for here. The contrastive pair algorithm gives you a vector direction. The magnitude of the vector can also be a control experiment but is less interesting. It is a known fact that if you steer too hard the model starts producing garbage.-->
